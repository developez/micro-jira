import { e as escape_html, a as attr_class, b as ensure_array_like, c as clsx, d as attr_style, f as stringify, h as attr, i as derived } from "../../chunks/root.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></tbody></table></div> <aside class="detail_sidebar svelte-1uha8ag"><div class="detail_layout_bar svelte-1uha8ag"><button class="icon_btn svelte-1uha8ag" type="button"${attr("title", "Ver detalle debajo")}${attr("aria-label", "Ver detalle debajo")}>`);
    {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<svg class="action_icon svelte-1uha8ag" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 4h16v6H4V4zm0 10h16v6H4v-6zm2-8v2h12V6H6zm0 10v2h12v-2H6z" class="svelte-1uha8ag"></path></svg>`);
    }
    $$renderer2.push(`<!--]--></button></div> <div class="detail_sidebar_header svelte-1uha8ag"><div class="detail_sidebar_key svelte-1uha8ag">${escape_html("Ningun item seleccionado")}</div> <div${attr_class(`detail_sidebar_summary ${stringify("muted")}`, "svelte-1uha8ag")}>${escape_html("Selecciona una fila para ver descripcion y comentarios.")}</div></div> <div class="detail_pane svelte-1uha8ag">`);
    {
      $$renderer2.push("<!--[0-->");
